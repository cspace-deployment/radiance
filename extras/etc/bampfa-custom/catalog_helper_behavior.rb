...
module Blacklight::CatalogHelperBehavior
  ...
  def thumbnail_url document
    if document.has? blacklight_config.view_config(document_index_view_type).thumbnail_field
      ...
      'https://webapps.cspace.berkeley.edu/bampfa/imageserver/blobs/' + document.first(blacklight_config.view_config(document_index_view_type).thumbnail_field) + '/derivatives/Medium/content'
    end
  end
